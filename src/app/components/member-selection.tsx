...
import type { Member, Gender } from "./insurance-form"
...
//   const toggleMember = (type: Member["type"]) => {
//     if (type === "self") {
//       // Toggle self, but don't allow deselection if other members are selected
//       if (members.length > 1 && isMemberSelected("self")) {
//         alert("Please remove other members before removing self")
//         return
//       }
//       if (isMemberSelected("self")) {
//         setMembers([])
//       } else {
//         setMembers([{ type: "self", id: "self" }])
//       }
//       return
//     }

//     // For other members, only allow selection if self is selected
//     if (!isMemberSelected("self")) {
//       alert("Please select self first")
//       return
//     }

//     const existingMember = members.find((m) => m.type === type)
//     if (existingMember) {
//       setMembers(members.filter((m) => m.type !== type))
//     } else {
//       setMembers([...members, { type, id: `${type}-${Date.now()}` }])
//     }
//   }
